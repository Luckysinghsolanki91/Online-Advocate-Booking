...
public class JwtUtil {
    private String secret="Advocate";
    //If i want extract user name and email so i want to write
    ...
    //here now we will compare the time of expiration
    ...
    //here we will validateToken is given token is right or not
